...
func (n *News) Node(ctx context.Context) (node *Node, err error) {
	...
	var buf []byte
	if buf, err = json.Marshal(n.UID); err != nil {
		return nil, err
	}
	node.Fields[0] = &Field{
		Type:  "int",
	...
	if buf, err = json.Marshal(n.HTML); err != nil {
		return nil, err
	}
	node.Fields[2] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(n.Markdown); err != nil {
		return nil, err
	}
	node.Fields[3] = &Field{
		Type:  "string",
	...
	if buf, err = json.Marshal(n.CreatorID); err != nil {
		return nil, err
	}
	node.Fields[4] = &Field{
		Type:  "int",
...
func (u *User) Node(ctx context.Context) (node *Node, err error) {
	...
	node.Edges[0] = &Edge{
		Type: "News",
		Name: "created_news_list",
	}
	err = u.QueryCreatedNewsList().
		Select(news.FieldID).
		Scan(ctx, &node.Edges[0].IDs)
	if err != nil {
		return nil, err
